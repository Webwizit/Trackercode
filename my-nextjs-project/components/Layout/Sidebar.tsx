...
import { 
  ...
  FaCalendarAlt, FaComments, FaPlug, FaEye, FaFile, FaFileAlt, FaChartPie, FaClipboardList, FaStream,
  FaGlobe, FaIdBadge, FaUsersCog, FaUser, FaTachometerAlt, FaCamera, FaChartLine, FaRegCalendarAlt,
  FaCalendarCheck, FaBalanceScale, FaSuitcaseRolling, FaUmbrellaBeach, FaArchive, FaFileContract,
  FaLayerGroup, FaFolderOpen, FaCommentAlt, FaEdit, FaRegClock 
} from "react-icons/fa";
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 h-screen bg-[#9A4AFD] text-white p-4">
      <nav>
        
        <ul className="space-y-2">
          <li className="p-2 rounded bg-white text-[#9A4AFD] font-bold">
          ...
          <li className="hover:bg-white hover:text-[#9A4AFD] p-2 rounded flex items-center gap-2 transition-all">
            <FaChartBar />
            <button onClick={() => toggleMenu("reports")} className="flex-1 text-left hover:text-blue">
              Reports
            </button>
            <FaChevronDown
            ...
            <ul className="pl-4 space-y-3">
              ...
              <li className="flex items-center gap-2 p-2 rounded hover:bg-white hover:text-[#9A4AFD] transition-all">
                ...
                <button
                  ...
                  className="flex items-center gap-2 p-2 rounded hover:bg-white hover:text-[#9A4AFD] transition-all"
                >
                  Statistics
                </button>
                <FaChevronDown
              ...
              {openMenus["statistics"] && (
                <ul className="pl-6 space-y-2">
                  ...
                  <li className="flex items-center gap-2 p-2 rounded hover:bg-white hover:text-[#9A4AFD] transition-alll">
                    <FaTasks />
          ...
          <li className="hover:bg-white hover:text-[#9A4AFD] p-2 rounded flex items-center gap-2 transition-all">
            <FaCommentAlt />
            <button onClick={() => toggleMenu("communication")} className="flex-1 text-left">
              Communication
            </button>
            <FaChevronDown
